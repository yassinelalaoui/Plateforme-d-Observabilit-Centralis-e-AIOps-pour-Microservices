...
**Tests**: Include tests proportionate to feature risk. Contract and integration tests are required
for changed service interactions; unit tests are required where they provide meaningful coverage.
...
- [ ] T010 Configure Docker Compose networks, non-root containers, private backing services, and
      scoped persistent volumes
- [ ] T011 Add OpenTelemetry tracing, structured logging, Prometheus metrics, and telemetry
      privacy/cardinality safeguards
- [ ] T012 Create required Grafana dashboard and actionable alert definitions for critical workflows
...
- [ ] TXXX Verify health/readiness, graceful shutdown, resource limits, and configuration validation
- [ ] TXXX Verify container isolation, exposed ports, image versions, and secret handling
- [ ] TXXX [P] Validate telemetry propagation, dashboard coverage, and alert response guidance
- [ ] TXXX [P] Validate ML artifact/version provenance, evaluation threshold, and rollback (if applicable)
